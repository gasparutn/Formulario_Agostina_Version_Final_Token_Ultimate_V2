  ...
  try {
    ...
    if (filaExistente) {
      try {
        ...
        hojaRegistro.getRange(filaExistente, COL_PRECIO).setNumberFormat(currencyFormat); // AE
        hojaRegistro.getRange(filaExistente, COL_CUOTA_1, 1, 3).setNumberFormat(currencyFormat); // AF, AG, AH
        hojaRegistro.getRange(filaExistente, COL_MONTO_A_PAGAR).setNumberFormat(currencyFormat); // AK
    ...
    hojaRegistro.getRange(nuevaFila, COL_PRECIO).setNumberFormat(currencyFormat); // AE
    hojaRegistro.getRange(nuevaFila, COL_CUOTA_1, 1, 3).setNumberFormat(currencyFormat); // AF, AG, AH
    hojaRegistro.getRange(nuevaFila, COL_MONTO_A_PAGAR).setNumberFormat(currencyFormat); // AK
    // --- (FIN DE LA MODIFICACIÓN v19) ---
